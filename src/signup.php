    ...
    <form class="navbar-form navbar-right" action="construction.php" style="padding:4px;">
		...
		<div class="container">
			...
			<nav class="breadcrumb">
				...
				<span class="breadcrumb-item active">Εγγραφή</span>
			</nav>
			<div class="row">
					<h1>Εγγραφή</h1>
					<hr>
				<div class="col-lg-6"> <!-- μηκος των πεδιων της φορμας -->
					...
					<form id="signin-form" method='post'>
						<div class="form-group">
							Επιθυμείτε να κάνετε εγγραφή ως :<br>
						...
						<div class="form-group">
							Επώνυμο:
							<input type="text" placeholder="Όνομα" name="epwnumo" class="form-control" required="required">
						</div>
						...
						<div class="form-group">
							Ημερομηνία γέννησης:
							<input type="date" name="birthdate" class="form-control" min="1910-01-01" max="2000-01-02" required="required">
						</div>
					...
					<script>
						function Sumbit_Function() {
							if($("#password").val() == $("#password_v").val()){
								document.getElementById("signin-form").action = "../php/signup.php";
							}
							else{
								alert("Λαθος Κωδικος");
							}
