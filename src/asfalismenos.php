...
<div class="service-section"> 
    <div class="container">
        ...
        <nav class="breadcrumb">
                ...
                <span class="breadcrumb-item active">Ασφαλισμένος</span>
        </nav>
        ...
        <div class="col-md-4 botmargin">
			...
			<?php
				if( isset($_SESSION['usr']) ){
					...
					{
						echo '
							<h4><a href="./forma.php">Αίτηση Συνταξιοδότησης</a></h4>
							';
					}
					else{
						echo '
							<h4><a onclick="return check()">Αίτηση Συνταξιοδότησης</a></h4>
							';
					}
				}
				else{
			...
			?>
            <p>Πλέον η αίτηση συνταξιοδότησης σας μπορεί να γίνει ηλεκτρονικά μέσω της πλατφόρμας του ΙΚΑ. </p>
        </div>
        ...
        <div class="col-md-4 botmargin">
            ...
            <h4><a href="./calculator.php">Υπολογισμός Σύνταξης</a></h4>
            <p>Υπολογίστε το προβλεπόμενο ποσό για την σύνταξη σας.</p>
        </div>
        <div class="col-md-4 botmargin">
            <span class="	glyphicon glyphicon-check icon"></span>
            <h4><a href="construction.php">Πιστοποίηση Ασφαλισμένου</a></h4>
            <p>Πιστοποίηση στοιχείων ασφαλισμένου. </p>
        </div>
        <div class="col-md-4 botmargin">
			...
			<?php
				if( isset($_SESSION['usr']) ){
					...
					{
						echo '
							<h4><a href="construction.php">Ατομικός Λογαριασμός Ασφάλισης</a></h4>
							';
					}
					else{
						echo '
							<h4><a onclick="return check()">Ατομικός Λογαριασμός Ασφάλισης</a></h4>
							';
					}
				}
				else{
			...
			?>
            <p>Υπηρεσίες σχετικά με τον προσωπικό σας λογαριασμό ασφάλισης.</p>
        </div>
        <div class="col-md-4 botmargin">
            <span class="	glyphicon glyphicon-briefcase icon"></span>
            <h4><a href="construction.php">Ασφαλιστική Ικανότητα</a></h4>
            <p>Υπηρεσίες για την ασφαλιστική ικανότητα. </p>
        </div>
        <div class="col-md-4 botmargin">
            <span class="glyphicon glyphicon-dashboard icon"></span>
            <h4><a href="construction.php">Πορεία της Αίτησης Συνταξιοδότησης</a></h4>
            <p>Παρακολουθήστε ηλεκτρονικά την πορεία της αίτησης συνταξιοδότησης σας.</p>
        </div>
...
<!-- After tools -->
<div class="foot"  style="margin-top:47%">    
    <div class="container">
