...
<html lang="en">
<head>
  <title>Χάρτης Ιστοτόπου | ΙΚΑ</title>
  <meta charset="utf-8">
	...
	<div class="row">
		<div class="col-sm-12">
                ...
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Χάρτης Ιστοτόπου</span>
            </nav>
            <h3>Χάρτης Ιστοτόπου</h3>
    	    <ul>
                <li><a href="./index.php"><strong>Αρχική</strong></a></li>   
                <li><a href="./ergodo.php"><strong>Εργοδότης</strong></a></li>
                <ul><li><a href="construction.php">Ασφάλιση Εργαζομένου</a></li><li><a href="construction.php">Οικονομική Καρτέλα Εργοδότη</a></li><li><a href="construction.php">Ασφαλιστική Ενημερώτητα</a></li></ul>
                <li><a href="asfalismenos.php"><strong>Ασφαλισμένος</strong></a></li>
                <ul><li><a href="construction.php">Αίτηση Συνταξιοδότησης</a></li><li><a href="./calculator.php">Υπολογισμός Σύνταξης</a></li><li><a href="construction.php">Ασφαλιστική Ικανότητα</a></li></ul>
