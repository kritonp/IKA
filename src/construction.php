...
<h2 style="text-align:center;"><a href="./index.php"><img src="../images/cons.jpg" alt="under construction" align="middle" /></a></h2>
<h2 style="text-align:center;">Η σελίδα είναι υπό κατασκευή</h2>
<h3 style="text-align:center;">Σύντομα κοντά σας </h3>


<div class="wrapp">
    <button class="backbtn" onclick="goBack()">Πίσω</button>
</div>
...
<!-- After tools -->
<div class="foot"  style="margin-top:26%">    
    <div class="container">
